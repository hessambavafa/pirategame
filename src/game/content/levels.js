export const STORY_LEVELS = [
  ...
  { id: 3, title: 'Shell Shore', tier: 1, waves: 5, reward: { gold: 45, gems: 1 }, allowedTemplates: ['choose_total_from_visual_groups', 'hit_marker_matching_grouped_objects', 'choose_larger_or_smaller_ship'] },
  ...
  { id: 7, title: 'Ten Chest Bay', tier: 2, waves: 5, reward: { gold: 65, gems: 2 }, allowedTemplates: ['choose_total_from_visual_groups', 'find_remaining_after_storm', 'hit_marker_matching_grouped_objects'] },
  { id: 8, title: 'Foamy Rescue', tier: 2, waves: 6, reward: { gold: 70, gems: 2 }, allowedTemplates: ['choose_larger_or_smaller_ship', 'hit_marker_matching_grouped_objects', 'find_remaining_after_storm'] },
  { id: 9, title: 'Number Bond Bay', tier: 3, waves: 6, reward: { gold: 75, gems: 2 }, allowedTemplates: ['choose_total_from_visual_groups', 'find_remaining_after_storm', 'hit_marker_matching_grouped_objects'] },
  { id: 10, title: 'Stormy Number Trail', tier: 3, waves: 6, reward: { gold: 80, gems: 2 }, allowedTemplates: ['hit_marker_matching_grouped_objects', 'choose_larger_or_smaller_ship', 'find_remaining_after_storm'] },
  { id: 11, title: 'Hidden Gold', tier: 3, waves: 6, reward: { gold: 85, gems: 2 }, allowedTemplates: ['choose_total_from_visual_groups', 'hit_marker_matching_grouped_objects', 'choose_larger_or_smaller_ship'] },
  { id: 12, title: 'Clever Current', tier: 3, waves: 6, reward: { gold: 90, gems: 3 }, allowedTemplates: ['find_remaining_after_storm', 'hit_marker_matching_grouped_objects', 'choose_total_from_visual_groups'] },
  { id: 13, title: 'Matey Math', tier: 3, waves: 6, reward: { gold: 95, gems: 3 }, allowedTemplates: ['choose_total_from_visual_groups', 'find_remaining_after_storm', 'hit_marker_matching_grouped_objects'] },
